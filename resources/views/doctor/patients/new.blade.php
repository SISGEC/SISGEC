...
@section('content')
    ...
    <div class="row align-items-center">
        ...
        <div class="col-6 text-right">
            <p class="c-grey-900 mT-10 mB-30">Fecha de elaboración: {{ date("h:i:s a d/m/Y") }}</p>
        </div>
    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" id="weight" name="measure[weight]" value="{{ old("measure.weight", "") }}" aria-describedby="weight-append" placeholder="00.00" />
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" id="height" name="measure[height]" value="{{ old("measure.height", "") }}" aria-describedby="height-append" placeholder="000" />
                                                <div class="input-group-append">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" id="temperature" name="measure[temperature]" value="{{ old("measure.temperature", "") }}" aria-describedby="temperature-append" placeholder="00.00" />
                                                <div class="input-group-append">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" id="heart_rate" name="measure[heart_rate]" value="{{ old("measure.heart_rate", "") }}" aria-describedby="heart_rate-append" placeholder="00" />
                                                <div class="input-group-append">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control" autocomplete="off" id="blood_pressure" name="measure[blood_pressure]" value="{{ old("measure.blood_pressure", "") }}" placeholder="000/00" />
                                        </div>
                                        <div class="col-4">
                                            <label or="breathing_frequency">{{ __("person.breathing_frequency") }}</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" autocomplete="off" id="breathing_frequency" name="measure[breathing_frequency]" value="{{ old("measure.breathing_frequency", "") }}" aria-describedby="breathing_frequency-append" placeholder="00" />
                                                <div class="input-group-append">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <textarea class="form-control" name="pathological[suicidal_risk]" id="suicidal_risk" cols="30" rows="1">{{ old("pathological.suicidal_risk", "") }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
