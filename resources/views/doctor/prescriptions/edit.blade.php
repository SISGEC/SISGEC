                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="date">{{ __("global.date") }}</label>
                                            <div class="input-group">
                                                <input type="text" data-provide="datepicker" class="form-control" id="date" name="date" placeholder="dd/mm/yyyy" value="{{ old("date", $prescription->date) }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="bgc-white p-20 bd">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="prescription" id="prescription" cols="30" rows="10">{{ old("prescription", $prescription->prescription) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
